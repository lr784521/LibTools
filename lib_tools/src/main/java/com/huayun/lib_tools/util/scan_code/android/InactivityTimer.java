...
public final class InactivityTimer {
    ...
    public synchronized void onPause() {
        ...
        if (registered) {
            ...
            LogUtil.xLoge("PowerStatusReceiver was never registered?");
        }
    }

    public synchronized void onResume() {
        if (registered) {
            LogUtil.xLoge("PowerStatusReceiver was already registered?");
        } else {
    ...
    private final class InactivityAsyncTask extends
        ...
        protected Object doInBackground(Object... objects) {
            try {
                ...
                LogUtil.xLoge("Finishing activity due to inactivity");
                activity.finish();
